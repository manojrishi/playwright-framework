...
- Name: masters-full.spec.ts >> Masters — HCP >> TC-HCP-014: Submitting blank HCP form blocks submission
- Location: tests/masters-full.spec.ts:570:7
...
Call log:
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <span class="menu-title ">Tasks</span> from <nav class="navbar wide-sidebar ">…</nav> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
