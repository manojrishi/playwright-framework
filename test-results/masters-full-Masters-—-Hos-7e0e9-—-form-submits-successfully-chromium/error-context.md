...
- Name: masters-full.spec.ts >> Masters — Hospital >> TC-HSP-002: Create hospital with all mandatory fields — form submits successfully
- Location: tests/masters-full.spec.ts:74:7
